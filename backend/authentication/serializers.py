...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields =['id', 'fund_balance', 'total_bets_won', 'status', 'current_bets', 'past_results']
...
class MyTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def get_token(cls, user):
        ...
        token["fund_balance"] = user.fund_balance
        token["total_bets_won"] = user.total_bets_won
...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('username', 'password', 'email',
                  'first_name', 'last_name', 'fund_balance', 'total_bets_won', 'status', 'current_bets', 'past_results')
